    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            const fieldName = yield vscode.window.showInputBox({
                ...
                validateInput: (value) => {
                    if (!(/^[[a-zA-Z0-9_]{3,40}(?<!_)__c$/.test(value))) {
...
function createField() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pickedSObject = yield pickSObjectType(SObjectFiles);
        if (pickedSObject) {
            try {
                ...
                SObjectFilesManager_1.default.writeSObjectDefinitionFile(path.join(pickedSObject.folder.toString(), pickedSObject.fileName), objectDefinition);
...
exports.default = {
    getObjectsFromMetaData: function () {
        const p = path.join(vscode.workspace.rootPath, 'src', 'classes');
...
exports.default = {
    getObjectsFromMetaData: function () {
        const p = path.join(vscode.workspace.rootPath, 'src', 'pages');
        const files = fs.readdirSync(p);
        if (files.length === 0) {
...
const UserPermission_1 = __webpack_require__(/*! ./structures/profile-fields-templates/UserPermission */ "./src/commands/metadatamanagement/profiles/structures/profile-fields-templates/UserPermission.ts");
exports.default = {
    getObjectsFromMetaData: function () {
        const p = path.join(vscode.workspace.rootPath, 'src', 'profiles');
        const files = fs.readdirSync(p);
        if (files.length === 0) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                profiles.forEach((profileFile) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    prof.Profile.fieldPermissions.sort((a, b) => utils_1.default.sortItemsByField(a, b, 'fullName'));
...
/***/ "./src/commands/metadatamanagement/profiles/structures/profile-fields-templates/UserPermission.ts":
/*!********************************************************************************************************!*\
  !*** ./src/commands/metadatamanagement/profiles/structures/profile-fields-templates/UserPermission.ts ***!
  \********************************************************************************************************/
/*! no static exports found */
...
exports.default = {
    getObjectsFromMetaData: function () {
        const p = path.join(vscode.workspace.rootPath, 'src', 'objects');
        const files = fs.readdirSync(p);
        if (files.length === 0) {
    ...
    generateSObjectDefinitions: function (fileNames, path) {
        return fileNames.map(filename => new SObjectFile_1.default(filename, path));
    },
    ...
    writeSObjectDefinitionFile: function (fileNamePath, stuffToWrite) {
        const builder = new xml2js.Builder({ xmldec: { standalone: undefined, encoding: 'UTF-8', version: '1.0' } });
        //Probably there's a bug in the builder class
        const xml = builder.buildObject(stuffToWrite);
        //130 is the number of characters of the first two lines containing header + root object definition
