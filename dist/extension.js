...
function configureDefaultFieldsProfiles() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const selectedProfiles = yield pickProfiles(profiles);
...
function configureProfilesApexClasses() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const profiles = ProfileFilesManager_1.default.getObjectsFromMetaData();
            const selectedProfile = yield pickProfile(profiles);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (pickedSObject) {
            try {
                ...
                objectDefinition.CustomObject.fields.sort((a, b) => utils_1.default.sortFieldsByField(a, b, 'fullName'));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                profiles.forEach((profileFile) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    prof.Profile.fieldPermissions.sort((a, b) => utils_1.default.sortFieldsByField(a, b, 'fullName'));
    ...
    updateProfilesApexClassesAccess: function (profile, enabledClasses) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                prof.Profile.classAccesses.sort((a, b) => utils_1.default.sortFieldsByField(a, b, 'apexClass'));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = {
    sortFieldsByField: (a, b, fieldName) => {
